...
class Struc2Vec():
    def __init__(self, graph, walk_length=10, num_walks=100, workers=1, verbose=0, stay_prob=0.3, opt1_reduce_len=True,
        ...
        self.graph = graph
        self.idx2node, self.node2idx = preprocess_nxgraph(graph)    # idx2node：节点key；node2idx：按顺序标记节点key：{'0': 0, '23819': 1, '23821': 2, '1': 3, '4834': 4, '2': 5, '5441': 6}
        self.idx = list(range(len(self.idx2node)))  # 0-44261
